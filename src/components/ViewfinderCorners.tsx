      ...
      <>
          ...
          <svg width="96" height="96" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="fadeMaskTL" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <stop offset="40%" stopColor="rgb(80, 80, 80)"/>
            ...
            <path d="M0 40V0H40" stroke="rgba(220, 38, 38, 0.6)" strokeWidth="1.5" fill="none" mask="url(#maskTL)"/>
          </svg>
        </div>
        ...
        <div className="absolute bottom-6 right-6 w-24 h-24 pointer-events-none z-20">
          <svg width="96" height="96" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="0" y="0" width="96" height="96" fill="none"/>
            <path d="M96 56V96H56" stroke="rgba(220, 38, 38, 0.6)" strokeWidth="1.5" fill="none" mask="url(#maskBR)"/>
          </svg>
        </div>
      </>
    )
      ...
      <>
        ...
        <div className="absolute top-6 right-6 w-24 h-24 pointer-events-none z-20">
          <svg width="96" height="96" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="0" y="0" width="96" height="96" fill="none"/>
            <path d="M96 40V0H56" stroke="rgba(220, 38, 38, 0.6)" strokeWidth="1.5" fill="none" mask="url(#maskTR)"/>
          </svg>
        </div>
        ...
        <div className="absolute bottom-6 left-6 w-24 h-24 pointer-events-none z-20">
          <svg width="96" height="96" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="0" y="0" width="96" height="96" fill="none"/>
            <path d="M0 56V96H40" stroke="rgba(220, 38, 38, 0.6)" strokeWidth="1.5" fill="none" mask="url(#maskBL)"/>
          </svg>
        </div>
      </>
    )
